              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="update_subcat2.php" method="post">
                      <div class="form-group">
                        <?php include("main_con.php");
                              $scid=$_GET['scid'];
                              $rs=mysqli_query($con,"select * from subcat1 where scid=$scid");
                              $row=mysqli_fetch_row($rs);
                                                    ?>
                        <label for="exampleInputName1">Subcategory ID</label>
                        <input type="text" class="form-control" value=<?php echo "$row[0]"; ?> id="scid" name="scid">
                      </div>
                      ...
                      <div>
                        ...
                        <input type="text" class="form-control" value=<?php echo "$row[2]"; ?> id="cid" name="cid">
                      </div>
