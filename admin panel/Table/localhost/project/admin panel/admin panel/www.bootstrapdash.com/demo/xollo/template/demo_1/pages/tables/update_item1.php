              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="update_item2.php" method="post">
                      <div class="form-group">
                        <?php include("main_con.php");
                              $id=$_GET['id'];
                              $rs=mysqli_query($con,"select * from item1 where item_id=$id");
                      ...
                      <div class="form-group">
                        ...
                        <input type="number"  class="form-control" value=<?php echo "$row[2]"; ?> id="pri" name="pri" placeholder="0">
                      </div>
                      <input type="hidden" name="item_id" value=<?php echo "$row[0]"; ?>>
                      <div class="form-group">
                        <label for="exampleTextarea1">Description</label>
                        <textarea class="form-control" value=  
                        id="desp"  name="desp" rows="4" ><?php echo "$row[3]"; ?></textarea>
                      </div>
                        

                      <div class="form-group">
                        <label for="exampleInputPassword4">Quantity</label>
                        <input type="text" class="form-control" value=<?php echo "$row[4]"; ?> id="quan" name="quan" placeholder="0">
                      </div>
