              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="inser_category1.php" method="post">

                       <div class="form-group">
                        <label for="exampleInputEmail3">Category ID</label>
                        <input type="number" class="form-control" id="pri" name="cid" placeholder="0">
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nm" name="cgn" placeholder="Name">
                      </div>
