...
<!-- Mirrored from organic-ishi.myshopify.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 17:23:30 GMT -->
    ...
    <div class="nav-header"> 
      <div class="page-width">
        ...
        <div class="header-block col-md-6 col-sm-6 col-xs-6 hidden-lg-down ">
          ...
          <div class='text'>Welcome To Fresh Mart</div>
        </div>
...
<div class="customer login ishi-panel-container">
  ...
  <div id="ishi-login-panel" class="ishi-panel-data ishi-panel-data-default active">
    <h2>
    Login
  </h2><form method="post" action="sign_in.php" id="customer_login" accept-charset="UTF-8" novalidate="novalidate"><input type="hidden" name="form_type" value="customer_login" /><input type="hidden" name="utf8" value="✓" /><div class="field">        
        <input
          type="email"
          name="mail1"
          id="CustomerEmail"
...
<div class="field">
  ...
  <div id="ishi-register-panel" class="ishi-panel-data ishi-panel-data-slide">
    <h2>
     Create account
    </h2><form method="post" action="login.php" id="create_customer" accept-charset="UTF-8" novalidate="novalidate"><input type="hidden" name="form_type" value="create_customer" /><input type="hidden" name="utf8" value="✓" /><div class="field">      
      <input
        type="text"
        name="nm"
  ...
  <div class="slideshow-block">
    ...
    <div class="ishislideshow-carousel ishislideshow-carousel-template--14172785508407__16289212707c98911d owl-carousel slider-with-options owl-theme logo-bar"
      ...
      <div class="slideshow__item" >
        <a href="collection.php" class="media"  style="padding-bottom: 18.867924528301888%;padding-top: 18.867924528301888%;">
...
<div class="grid__item grid__item--template--14172785508407__163479156428f62071 productdeal"
        ...
        <div class="card-wrapper">
          <div class="card card--product col-xl-5 col-lg-6 col-md-5 col-sm-12 col-xs-12" tabindex="-1">
            <div class="card__inner ">
              <a href="collection.php" class="full-unstyled-link"><div class="media media--transparent media--square media--hover-effect"
          ...
          <div class="card-information col-xl-7 col-lg-6 col-md-7 col-sm-12 col-xs-12">
            <div class="card-information__wrapper"><span class="card-information__text h5">
                <a href="collection.php" class="full-unstyled-link">
                   Orange
                </a>
              </span>
...
<div class="product-desc">Oranges are rich in vitamin C and they taste good and sour</div>
...
<div class="product-desc"> Apples are an incredibly nutritious fruit that offers multiple health benefits.</div>
              <div class="countdowncontainer">
                <div class="countdown">
                  <div class="countdown-days data">00</div>
                  <div class="text">Days</div>
...
<div class="product-desc">Bananas contain a number of vitamins and minerals.</div>
              <div class="countdowncontainer">
                <div class="countdown">
                  <div class="countdown-days data">00</div>
                  <div class="text">Days</div>
...
<section id="shopify-section-template--14172785508407__1634711923e17a85a1" class="shopify-section ishi-testimonial-section">
<style type="text/css">
...
<section id="shopify-section-template--14172785508407__1634713635e8269792" class="shopify-section ishi-smartblog-section">
